...
(12, 'cms_email_forgot_message', 'Dear, {{ user_real_name }}<br />Click <a href="{{ activation_link }}">{{ activation_link }}</a> to reactivate your account', 'Email message sent when user forgot his/her password'),
(13, 'cms_email_signup_subject', 'Activate your account at No-CMS', 'Email subject sent to activate user'),
(14, 'cms_email_signup_message', 'Dear, {{ user_real_name }}<br />Click <a href="{{ activation_link }}">{{ activation_link }}</a> to activate your account', 'Email message sent to activate user'),
