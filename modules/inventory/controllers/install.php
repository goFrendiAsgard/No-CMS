...
/**
 * Installation script for inventory
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.inventory';
    ...
    protected function do_deactivate(){
        ...
        $this->backup_database(array(
            $this->cms_complete_table_name('barang'),
    ...
    private function remove_all(){
        ...
        // remove navigations
        $this->remove_navigation($this->cms_complete_navigation_name('browse_barang'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_kategori'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_barang'));
        ...
        // drop tables
        $this->dbforge->drop_table($this->cms_complete_table_name('kategori_barang'), TRUE);
        $this->dbforge->drop_table($this->cms_complete_table_name('kategori'), TRUE);
        $this->dbforge->drop_table($this->cms_complete_table_name('barang'), TRUE);
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Inventory',
            $module_path.'/inventory', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('browse_barang'), 'Browse Barang',
            $module_path.'/browse_barang', $this->PRIV_EVERYONE, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_barang'), 'Manage Barang',
            $module_path.'/manage_barang', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_kategori'), 'Manage Kategori',
            $module_path.'/manage_kategori', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        ...
        // barang
        $fields = array(
            'id_barang'=> $this->TYPE_INT_UNSIGNED_AUTO_INCREMENT,
            'kode_barang'=> array("type"=>'varchar', "constraint"=>20, "null"=>TRUE),
            'nama'=> array("type"=>'varchar', "constraint"=>30, "null"=>TRUE),
            'kategori'=> array("type"=>'varchar', "constraint"=>255, "null"=>TRUE)
        );
        $this->dbforge->add_field($fields);
        $this->dbforge->add_key('id_barang', TRUE);
        $this->dbforge->create_table($this->cms_complete_table_name('barang'));
        ...
        $this->dbforge->create_table($this->cms_complete_table_name('kategori'));

        // kategori_barang
        $fields = array(
            'id'=> $this->TYPE_INT_UNSIGNED_AUTO_INCREMENT,
            'id_barang'=> array("type"=>'int', "constraint"=>10, "null"=>TRUE),
            'id_kategori'=> array("type"=>'int', "constraint"=>10, "null"=>TRUE)
        );
        $this->dbforge->add_field($fields);
        $this->dbforge->add_key('id', TRUE);
        $this->dbforge->create_table($this->cms_complete_table_name('kategori_barang'));
