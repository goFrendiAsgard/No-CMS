...
/**
 * Description of Manage_Kategori
 *
 * @author No-CMS Module Generator
 */
class Manage_Kategori extends CMS_Priv_Strict_Controller {
	...
	public function index(){
        ...
        // set model
        $crud->set_model($this->cms_module_path().'/grocerycrud_kategori_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('kategori'));
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/manage_kategori_view', $output,
            $this->cms_complete_navigation_name('manage_kategori'));
