...
class Install_Model extends CI_Model{
    ...
    protected function insert_all_data(){
        ...
        $sql_list[] = $this->insert_widget('navigation_right_partial', 'top navigation right partial', 'Right Partial of Top Navigation Bar. Use this when you want to add something like facebook login form', NULL, 1, 1, 17, 1, NULL, NULL);
        // privilege
