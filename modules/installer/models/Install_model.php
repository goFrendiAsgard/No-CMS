...
class Install_model extends CI_Model{
    ...
    protected function insert_all_data($config=NULL){
        ...
        $this->insert_layouts(array(
                array('default', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div id="__section-banner">{{ widget_name:section_banner }}</div>' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-left" class="hidden">' . PHP_EOL . '                                {{ widget_name:section_left }}                                    ' . PHP_EOL . '                            </div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-left is empty, remove it' . PHP_EOL . '                if($.trim($(\'#__section-left\').html()) == \'\'){' . PHP_EOL . '                    $(\'#__section-left\').remove();' . PHP_EOL . '                }else{' . PHP_EOL . '                    $(\'#__section-content\').removeClass(\'col-md-12\');' . PHP_EOL . '                    $(\'#__section-content\').addClass(\'col-md-9\');' . PHP_EOL . '                    $(\'#__section-left\').removeClass(\'hidden\');' . PHP_EOL . '                    $(\'#__section-left\').addClass(\'col-md-3\');' . PHP_EOL . '                }' . PHP_EOL . '                // if section-right is empty, remove it' . PHP_EOL . '                if($.trim($(\'#__section-right\').html()) == \'\'){' . PHP_EOL . '                    $(\'#__section-right\').remove();' . PHP_EOL . '                    $(\'#__section-left-and-content\').removeClass(\'col-md-9\');' . PHP_EOL . '                    $(\'#__section-left-and-content\').addClass(\'col-md-12\');' . PHP_EOL . '                }' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('default-one-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div id="__section-banner">{{ widget_name:section_banner }}</div>' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-12">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('default-two-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div id="__section-banner">{{ widget_name:section_banner }}</div>' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('default-three-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div id="__section-banner">{{ widget_name:section_banner }}</div>' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-left" class="col-md-3">' . PHP_EOL . '                                {{ widget_name:section_left }}                                    ' . PHP_EOL . '                            </div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-9">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('slide', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        {{ widget_name:static_accessories_slideshow }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-left" class="hidden">' . PHP_EOL . '                                {{ widget_name:section_left }}                                    ' . PHP_EOL . '                            </div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-left is empty, remove it' . PHP_EOL . '                if($.trim($(\'#__section-left\').html()) == \'\'){' . PHP_EOL . '                    $(\'#__section-left\').remove();' . PHP_EOL . '                }else{' . PHP_EOL . '                    $(\'#__section-content\').removeClass(\'col-md-12\');' . PHP_EOL . '                    $(\'#__section-content\').addClass(\'col-md-9\');' . PHP_EOL . '                    $(\'#__section-left\').removeClass(\'hidden\');' . PHP_EOL . '                    $(\'#__section-left\').addClass(\'col-md-3\');' . PHP_EOL . '                }' . PHP_EOL . '                // if section-right is empty, remove it' . PHP_EOL . '                if($.trim($(\'#__section-right\').html()) == \'\'){' . PHP_EOL . '                    $(\'#__section-right\').remove();' . PHP_EOL . '                    $(\'#__section-left-and-content\').removeClass(\'col-md-9\');' . PHP_EOL . '                    $(\'#__section-left-and-content\').addClass(\'col-md-12\');' . PHP_EOL . '                }' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('slide-one-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        {{ widget_name:static_accessories_slideshow }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-12">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('slide-two-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        {{ widget_name:static_accessories_slideshow }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-12">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array('slide-three-column', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}        ' . PHP_EOL . '        {{ widget_name:static_accessories_slideshow }}' . PHP_EOL . '        <div class="container">' . PHP_EOL . '            <div class="row-fluid">' . PHP_EOL . '                <div>' . PHP_EOL . '                    <div id="__section-left-and-content" class="col-md-9">' . PHP_EOL . '                        <div>{{ navigation_path }}</div><hr />' . PHP_EOL . '                        <div>' . PHP_EOL . '                            <div id="__section-left" class="col-md-3">' . PHP_EOL . '                                {{ widget_name:section_left }}                                    ' . PHP_EOL . '                            </div>' . PHP_EOL . '                            <div id="__section-content" class="col-md-9">' . PHP_EOL . '                                {{ layout:body }}' . PHP_EOL . '                            </div>' . PHP_EOL . '                        </div>' . PHP_EOL . '                    </div><!--/#layout-content-->' . PHP_EOL . '                    <div id="__section-right" class="col-md-3">' . PHP_EOL . '                        {{ widget_name:section_right }}' . PHP_EOL . '                    </div><!--/#layout-widget-->' . PHP_EOL . '                </div>' . PHP_EOL . '            </div><!--/row-->' . PHP_EOL . '          <hr>' . PHP_EOL . '        </div><!--/.fluid-container-->' . PHP_EOL . '        <footer>{{ widget_name:section_bottom }}</footer>' . PHP_EOL . '        <script type="text/javascript">' . PHP_EOL . '            $(document).ready(function(){' . PHP_EOL . '                // if section-banner is empty, remove it' . PHP_EOL . '                if($.trim($(\'__section-banner\').html()) == \'\'){' . PHP_EOL . '                    $(\'__section-banner\').remove();' . PHP_EOL . '                }' . PHP_EOL . '            });' . PHP_EOL . '        </script>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
                array ('minimal', '<!DOCTYPE html>' . PHP_EOL . '<html lang="{{ language:language_alias }}">' . PHP_EOL . '    <head>' . PHP_EOL . '        <meta charset="utf-8">' . PHP_EOL . '        <title>{{ layout:title }}</title>' . PHP_EOL . '        {{ layout:metadata }}' . PHP_EOL . '        <link rel="icon" href="{{ site_favicon }}">' . PHP_EOL . '        <!-- Le styles -->' . PHP_EOL . '        {{ layout:css }}' . PHP_EOL . '        <style type="text/css">{{ widget_name:section_custom_style }}</style>' . PHP_EOL . '        <!-- Le fav and touch icons -->' . PHP_EOL . '        <link rel="shortcut icon" href="{{ site_favicon }}">        ' . PHP_EOL . '    </head>' . PHP_EOL . '    <body>' . PHP_EOL . '        {{ layout:js }}' . PHP_EOL . '        <script type="text/javascript">{{ widget_name:section_custom_script }}</script>' . PHP_EOL . '        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->' . PHP_EOL . '        <!--[if lt IE 9]>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/html5.js"></script>' . PHP_EOL . '            <script src="{{ BASE_URL }}assets/no_cms/js/respond.min.js"></script>' . PHP_EOL . '        <![endif]-->' . PHP_EOL . '        ' . PHP_EOL . '        {{ widget_name:section_top_fix }}' . PHP_EOL . '        <div class="container">{{ layout:body }}</div>' . PHP_EOL . '    </body>' . PHP_EOL . '</html>' . PHP_EOL . ''),
        ));
