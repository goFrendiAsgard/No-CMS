...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'New Blog',
            $module_path.'/new_blog', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('browse_article'), 'Browse Article',
            $module_path.'/browse_article', $this->PRIV_EVERYONE, $this->cms_complete_navigation_name('index')
        );
