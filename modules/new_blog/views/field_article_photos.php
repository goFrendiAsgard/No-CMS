...
<style type="text/css">
	...
	#md_table_photos .md_field_photos_col{
		width:auto!important;
		min-width:50px!important;
		max-width:150px!important;
	}
	#md_table_photos .datepicker-input{
		width:auto!important;
		min-width:50px!important;
		max-width:100px!important;
	}
	#md_table_photos .chzn-container,
	#md_table_photos .chzn-drop{
		width:auto!important;
...
<script type="text/javascript">
	...
	function add_table_row_photos(value){
		...
		component += '<td>';
		component += '<input id="md_field_photos_col_url_'+RECORD_INDEX_photos+'" record_index="'+RECORD_INDEX_photos+'" class="md_field_photos_col" column_name="url" type="text" value="'+field_value+'"/>';
		component += '</td>';
		...
		// Delete Button
		/////////////////////////////////////////////////////////////////////////////////////////////////////
		component += '<td><input class="md_field_photos_delete btn" record_index="'+RECORD_INDEX_photos+'" primary_key="" type="button" value="Delete Photo" /></td>';
		component += '</tr>';
	...
	$(document).ready(function(){
		...
		synchronize_photos();
		for(var i=0; i<old_data.length; i++){
			add_table_row_photos(old_data[i]);
			RECORD_INDEX_photos++;
		}
