...
/**
 * Installation script for clausanoid
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.clausanoid';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Clausanoid',
            $module_path.'/clausanoid', $this->PRIV_EVERYONE);
