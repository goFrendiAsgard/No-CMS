...
/**
 * Description of Manage_visitor_counter
 *
 * @author No-CMS Module Generator
 */
class Manage_visitor_counter extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'visitor_counter';
    protected $COLUMN_NAMES = array('ip', 'time', 'agent');
    protected $PRIMARY_KEY = 'counter_id';
    ...
    protected function make_crud(){
        ...
        //$crud->columns('ip', 'time', 'agent');
        //$crud->edit_fields('ip', 'time', 'agent', '_updated_by', '_updated_at');
        //$crud->add_fields('ip', 'time', 'agent', '_created_by', '_created_at');
        //$crud->set_read_fields('ip', 'time', 'agent');
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/Manage_visitor_counter_view', $output,
            $this->n('manage_visitor_counter'), $config);
    }
