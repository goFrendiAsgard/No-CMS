 ...
 */
class Manage_tab_content extends CMS_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        //$crud->edit_fields('caption', 'content', '_updated_by', '_updated_at');
        //$crud->add_fields('caption', 'content', '_created_by', '_created_at');
        //$crud->set_read_fields('caption', 'content');
    ...
    public function index(){
        ...
        $this->view($this->cms_module_path().'/Manage_tab_content_view', $output,
            $this->n('manage_tab_content'), $config);
    }
