...
class _Info extends CMS_Module_Info_Model{
    ...
    public $NAME         = 'gofrendi.noCMS.static_accessories';
    public $DESCRIPTION  = 'This widget contains several widgets such a slideshow, tabbed content, and visitor counter';
