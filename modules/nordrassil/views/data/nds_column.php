...
<script type="text/javascript">	
	...
	$(document).ready(function(){
		...
		var get_restricted_path_1 = Array('<?php echo site_url($cms['module_path']); ?>'+'/data/ajax/get_restricted_column_option/',
		...
		var get_restricted_path_2 = '<?php echo site_url($cms['module_path']); ?>'+'/data/ajax/get_restricted_column/';
		...
		var get_restricted_path_3 = '<?php echo site_url($cms['module_path']); ?>'+'/data/ajax/get_restricted_column/';
		...
		var get_restricted_path_4 = '<?php echo site_url($cms['module_path']); ?>'+'/data/ajax/get_restricted_column/';
