...
/**
 * Description of Manage_Jenis_Lomba
 *
 * @author No-CMS Module Generator
 */
class Manage_Jenis_Lomba extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        // set model
        $crud->set_model($this->cms_module_path().'/grocerycrud_jenis_lomba_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('jenis_lomba'));

        // set subject
        $crud->set_subject('Jenis Lomba');
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/manage_jenis_lomba_view', $output,
            $this->cms_complete_navigation_name('manage_jenis_lomba'));
