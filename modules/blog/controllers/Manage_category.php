 ...
 */
class Manage_category extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'category';
    protected $COLUMN_NAMES = array('category_name', 'description', 'category_article');
    ...
    protected function make_crud(){
        ...
        //$crud->columns('category_name', 'description', 'category_article');
        //$crud->edit_fields('category_name', 'description', 'category_article', '_updated_by', '_updated_at');
        //$crud->add_fields('category_name', 'description', 'category_article', '_created_by', '_created_at');
        //$crud->set_read_fields('category_name', 'description', 'category_article');

        // caption of each columns
        $crud->display_as('category_name','Category Name');
        $crud->display_as('description','Description');
        $crud->display_as('category_article','Articles');
    ...
    public function _after_delete($primary_key){
        $this->db->delete($this->t('category_article'), array('category_id' => $primary_key));
        return TRUE;
    }
