            ...
            <div class="col-sm-8 col-md-8 col-xs-8">
                <div class="tab-content">  
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="admin_user_name">Super admin's Username</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="adm_real_name">Super admin's Real Name</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="admin_password">Super admin's Password</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="admin_confirm_password">Password Confirmation</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab3">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_facebook">Allow Facebook Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_facebook_app_id">Facebook Application ID</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_facebook_app_secret">Facebook Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab4">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_twitter">Allow Twitter Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_twitter_app_id">Twitter Application Key</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_twitter_app_secret">Twitter Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab5">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_google">Allow Google Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_google_app_id">Google Application ID</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_google_app_secret">Google Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab6">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_yahoo">Allow Yahoo Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_yahoo_app_id">Yahoo Application ID</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_yahoo_app_secret">Yahoo Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab7">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_linkedin">Allow linkedIn Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_linkedin_app_key">LinkedIn Application Key</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_linkedin_app_secret">LinkedIn Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_myspace">Allow MySpace Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_myspace_app_id">MySpace Application Key</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_myspace_app_secret">MySpace Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab9">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_foursquare">Allow Foursquare Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_foursquare_app_id">Foursquare Application ID</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_foursquare_app_secret">foursquare Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab10">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_windows_live">Allow Windows Live Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_windows_live_app_id">Windows Live Application ID</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_windows_live_app_secret">windows_live Application Secret</label>
                           <div class="controls col-md-8">
                    ...
                    <div class="tab-pane" id="tab11">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_open_id">Allow Open Id Authentication</label>
                           <div class="controls col-md-8">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-4" for="auth_enable_aol">Allow AOL Authentication</label>
                           <div class="controls col-md-8">
