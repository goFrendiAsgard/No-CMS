...
class Subsite_model extends  CMS_Model{
    ...
    public function update_configs(){
            ...
            if($row->modules != ''){
                ...
                foreach($modules_array as $module){
                    ...
                    foreach($cms_module_list as $cms_module){
                        if($module == $cms_module['module_name']){
                            // change module_name to module_path
                            $module = $cms_module['module_path'];
        ...
        foreach($module_auth_list as $module=>$subsite_array){
            ...
            $content .= '// Automatically written by multisite module'.PHP_EOL;
