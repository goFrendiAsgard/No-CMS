 ...
 */
class Manage_Subsite extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        // set model
        // $crud->set_model($this->cms_module_path().'/grocerycrud_subsite_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('subsite'));

        // set subject
        $crud->set_subject('Subsite');

        // displayed columns on list
        $crud->columns('name','use_subdomain','logo','description');
        // displayed columns on edit operation
        $crud->edit_fields('name','use_subdomain','logo','description');
        // displayed columns on add operation
        $crud->add_fields('name','use_subdomain','logo','description');
        ...
        $crud->set_field_upload('logo', 'modules/'.$this->cms_module_path().'/assets/uploads');
        ...
        $this->view($this->cms_module_path().'/manage_subsite_view', $output,
            $this->cms_complete_navigation_name('manage_subsite'));
