...
/**
 * Installation script for kampus
 *
...
class Install extends CMS_Module_Installer {
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Kampus',
            $module_path.'/kampus', $this->PRIV_EVERYONE);
