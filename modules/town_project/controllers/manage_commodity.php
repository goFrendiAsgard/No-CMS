 ...
 */
class Manage_Commodity extends CMS_Priv_Strict_Controller {
	...
	public function index(){
		...
		**/
		$crud->field_type('type', 'set', array('mines','livestock','vegetables','fruit','maritime','industrial'));
        ...
        // render
        $output = $crud->render();        
        $this->view($this->cms_module_path().'/manage_commodity_view', $output, 'cms_well_name($module_path,'manage_commodity')');
