 ...
 */
class Manage_Citizen extends CMS_Priv_Strict_Controller {
	...
	public function index(){
        ...
        // set model
        $crud->set_model($this->cms_module_path().'/grocerycrud_citizen_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('citizen'));

        // set subject
        $crud->set_subject('Citizen');

        // displayed columns on list
        $crud->columns('town_id','name','birthdate','job_id','IQ','Capita','hobby');
        // displayed columns on edit operation
        $crud->edit_fields('town_id','name','birthdate','job_id','IQ','Capita','hobby');
        // displayed columns on add operation
        $crud->add_fields('town_id','name','birthdate','job_id','IQ','Capita','hobby');

        // caption of each columns
        $crud->display_as('town_id','Town');
        $crud->display_as('name','Name');
        $crud->display_as('birthdate','Birthdate');
        $crud->display_as('job_id','Job');
        $crud->display_as('IQ','IQ');
        $crud->display_as('Capita','Capita');
		...
		**/
		$crud->set_relation('town_id', $this->cms_complete_table_name('town'), 'name');
		$crud->set_relation('job_id', $this->cms_complete_table_name('job'), 'name');
		...
		**/
        ...
        $this->view($this->cms_module_path().'/manage_citizen_view', $output,
            $this->cms_complete_navigation_name('manage_citizen'));
