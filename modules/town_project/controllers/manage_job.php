 ...
 */
class Manage_Job extends CMS_Priv_Strict_Controller {
	...
	public function index(){
		...
		**/
        ...
        // render
        $output = $crud->render();        
        $this->view($this->cms_module_path().'/manage_job_view', $output, 'cms_well_name($module_path,'manage_job')');
