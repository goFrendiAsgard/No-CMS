...
/**
 * Description of Manage_Town
 *
 * @author No-CMS Module Generator
 */
class Manage_Town extends CMS_Priv_Strict_Controller {
	...
	public function index(){
        ...
        // set model
        $crud->set_model($this->cms_module_path().'/grocerycrud_town_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('town'));

        // set subject
        $crud->set_subject('Town');

        // displayed columns on list
        $crud->columns('country_id','name','commodity','citizen');
        // displayed columns on edit operation
        $crud->edit_fields('country_id','name','commodity','citizen');
        // displayed columns on add operation
        $crud->add_fields('country_id','name','commodity','citizen');
		...
		**/
        ...
        // render
        $output = $crud->render();
        $this->view($this->cms_module_path().'/manage_town_view', $output,
            $this->cms_complete_navigation_name('manage_town'));
	...
	public function after_insert_or_update($post_array, $primary_key){
		...
		$real_column_names = array('citizen_id', 'name', 'birthdate', 'job_id', 'IQ', 'Capita');
	...
	public function callback_field_citizen($value, $primary_key){
		...
		$query = $this->db->select('citizen_id, name, birthdate, job_id, IQ, Capita')
			->from($this->cms_complete_table_name('citizen'))
			->where('town_id', $primary_key)
			->get();
		...
		return $this->load->view('town_project/field_town_citizen',$data, TRUE);
	}
