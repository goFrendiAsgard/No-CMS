...
/**
 * Installation script for front_widget
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.front_widget';
    ...
    protected function do_deactivate(){
        ...
        $this->backup_database(array(
            $this->cms_complete_table_name('slideshow'),
            $this->cms_complete_table_name('tab')
        ));
        $this->remove_all();
    }
    ...
    private function remove_all(){
        ...
        // remove navigations
        $this->remove_navigation($this->cms_complete_navigation_name('manage_tab'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_slideshow'));
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Front Widget',
            $module_path.'/front_widget', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('manage_slideshow'), 'Manage Slideshow',
            $module_path.'/manage_slideshow', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_tab'), 'Manage Tab',
            $module_path.'/manage_tab', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
