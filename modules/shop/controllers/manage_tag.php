...
/**
 * Description of Manage_Tag
 *
 * @author No-CMS Module Generator
 */
class Manage_Tag extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        // set model
        // $crud->set_model($this->cms_module_path().'/grocerycrud_tag_model');

        // adjust groceryCRUD's language to No-CMS's language
        $crud->set_language($this->cms_language());

        // table name
        $crud->set_table($this->cms_complete_table_name('tag'));
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $output = $crud->render();
        $this->view($this->cms_module_path().'/manage_tag_view', $output,
            $this->cms_complete_navigation_name('manage_tag'));
