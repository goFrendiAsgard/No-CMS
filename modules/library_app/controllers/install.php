...
/**
 * Installation script for library_app
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.library_app';
    ...
    protected function do_deactivate(){
        ...
        $this->backup_database(array(
            $this->cms_complete_table_name('book'),
            $this->cms_complete_table_name('book_category'),
            $this->cms_complete_table_name('borrowing'),
            $this->cms_complete_table_name('borrowing_detail'),
            $this->cms_complete_table_name('category'),
            $this->cms_complete_table_name('member'),
            $this->cms_complete_table_name('physical_book')
        ));
        $this->remove_all();
    }
    ...
    private function remove_all(){
        ...
        // remove navigations
        $this->remove_navigation($this->cms_complete_navigation_name('browse_book'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_member'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_category'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_borrowing'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_book'));
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Library App',
            $module_path.'/library_app', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('browse_book'), 'Browse Book',
            $module_path.'/browse_book', $this->PRIV_EVERYONE, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_book'), 'Manage Book',
            $module_path.'/manage_book', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_borrowing'), 'Manage Borrowing',
            $module_path.'/manage_borrowing', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        ...
        $this->add_navigation($this->cms_complete_navigation_name('manage_member'), 'Manage Member',
            $module_path.'/manage_member', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
