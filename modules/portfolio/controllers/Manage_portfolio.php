...
/**
 * Description of Manage_portfolio
 *
 * @author No-CMS Module Generator
 */
class Manage_portfolio extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'portfolio';
    protected $COLUMN_NAMES = array('name', 'id_category', 'url', 'image', 'description');
    ...
    protected function make_crud(){
        ...
        //$crud->columns('name', 'id_category', 'url', 'image', 'description');
        //$crud->edit_fields('name', 'id_category', 'url', 'image', 'description', '_updated_by', '_updated_at');
        //$crud->add_fields('name', 'id_category', 'url', 'image', 'description', '_created_by', '_created_at');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->set_relation('id_category', $this->t('category'), 'name');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->set_field_upload('image', 'modules/'.$this->cms_module_path().'/assets/uploads/');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_portfolio_view', $output,
            $this->n('manage_portfolio'), $config);
    }
