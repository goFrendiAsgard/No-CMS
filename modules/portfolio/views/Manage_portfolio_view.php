...
echo $output;
?>
<a class="btn btn-primary" href="{{ site_url }}{{ module_path }}/browse_portfolio/index">{{ language:Show Front Page }}</a><script type="text/javascript">
    ...
    $('.delete_all_button').live('click', function(event){
        ...
        //send data to delete
        $.post('{{ MODULE_SITE_URL }}Manage_portfolio/delete_selection', { data: JSON.stringify(list) }, function(data) {
