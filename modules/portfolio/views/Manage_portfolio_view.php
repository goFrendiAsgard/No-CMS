...
echo $output;
?>
<a class="btn btn-primary" href="{{ site_url }}{{ module_path }}/browse_portfolio/index">{{ language:Show Front Page }}</a>

<script type="text/javascript">
    // This function will add checkboxes and "Delete selected" button.
    add_delete_all_feature(
        '{{ MODULE_SITE_URL }}Manage_portfolio/delete_selection', // url
