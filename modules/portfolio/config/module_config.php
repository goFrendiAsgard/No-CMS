...
$config['portfolio_record_template'] ='<div id="record_{{ record:id }}" class="record_container panel panel-default">'.PHP_EOL.
    ...
    '        {{ record:image }}'.PHP_EOL.
    ''.PHP_EOL.
    '        <div class="col-md-12" style="padding-top:10px;">'.PHP_EOL.
    '        {{ record:url }}'.PHP_EOL.
    '        <a target="blank" class="btn btn-primary" href="{{ MODULE_BASE_URL }}assets/uploads/{{ record:image }}"><i class="glyphicon glyphicon-image"></i> Show</a>'.PHP_EOL.
    '        </div>'.PHP_EOL.
    ''.PHP_EOL.
    '    </td>'.PHP_EOL.
