...
<script type="text/javascript">
    ...
    function add_table_row_cloudmade_basemap(value){
        ...
        var html = '<input id="'+input_id+'" record_index="'+row_index+'" class="'+input_prefix+'" column_name="url" type="text" value="'+field_value+'"/>';
        inputs.push(html);

        // FIELD "max_zoom"
        var input_id    = input_prefix + 'max_zoom' + row_index;
        var field_value = get_object_property_as_str(value, 'max_zoom');
        var html = '<input id="'+input_id+'" record_index="'+row_index+'" class="'+input_prefix+' numeric" column_name="max_zoom" type="text" value="'+field_value+'"/>';
        inputs.push(html);
