...
class Manage_layer extends CMS_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->required_fields('map_id', 'layer_name', 'group_name', 'z_index', 'shown', 'radius', 'fill_color', 'color', 'weight', 'opacity', 'fill_opacity', 'use_json_url', 'searchable', 'use_search_url');
