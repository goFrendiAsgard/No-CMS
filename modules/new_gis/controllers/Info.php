...
class Info extends CMS_Module {
    ...
    protected $DATA = array(
        'layer' => array(
            array('layer_id' => '1', 'map_id' => '1', 'layer_name' => 'All Airports', 'group_name' => '', 'layer_desc' => 'Airports in all alaska', 'z_index' => '0', 'shown' => '1', 'radius' => '4', 'fill_color' => '#ff7800', 'color' => '#000000', 'weight' => '1', 'opacity' => '1', 'fill_opacity' => '0.8', 'image_url' => '', 'json_sql' => '', 'json_shape_column' => '', 'json_popup_content' => '', 'json_label' => '', 'use_json_url' => '1', 'json_url' => '{{ site_url }}$cms_module_path/alaska_airport/geojson', 'searchable' => '1', 'search_sql' => 'SELECT `name`, `use`, `elev`, x(`shape`) as `x`, y(`shape`) as `y`\nFROM {{ table_alaska_airport }}\nWHERE name LIKE \'%@keyword%\';', 'search_result_content' => '<b>@name</b><br />\nUsage : @use<br />\nElevation : @elev<br />\nCoordinate: (@x,@y)', 'search_result_x_column' => 'x', 'search_result_y_column' => 'y', 'use_search_url' => '0', 'search_url' => ''),
            array('layer_id' => '2', 'map_id' => '1', 'layer_name' => 'Civilian/Public', 'group_name' => 'Airports by usage', 'layer_desc' => 'Civilian/Public Airport', 'z_index' => '0', 'shown' => '0', 'radius' => '20', 'fill_color' => '#ff7800', 'color' => '#000000', 'weight' => '1', 'opacity' => '1', 'fill_opacity' => '0.8', 'image_url' => '{{ base_url }}modules/$cms_module_path/assets/images/black_plane.png', 'json_sql' => 'SELECT `cat`, `name`, `use`, `elev`, astext(`shape`) as `shape`, x(`shape`) as `lat`, y(`shape`) as `long`\nFROM {{ table_alaska_airport }}\nWHERE `use`=\'Civilian/Public\' AND (MBRIntersects(`shape`,geomfromtext(\'@map_region\'))=1) AND (@map_zoom > 3) ;', 'json_shape_column' => 'shape', 'json_popup_content' => '<b>Civilian Airport</b><br />Name: @name<br />Latitude: @lat<br />Longitude:@long', 'json_label' => '@name', 'use_json_url' => '0', 'json_url' => '', 'searchable' => '0', 'search_sql' => '', 'search_result_content' => '', 'search_result_x_column' => '', 'search_result_y_column' => '', 'use_search_url' => '0', 'search_url' => ''),
        ...
        'cloudmade_basemap' => array(
            array('basemap_id' => '1', 'map_id' => '1', 'basemap_name' => 'Open Street Map', 'url' => 'http://{s}.tile.cloudmade.com/BC9A493B41014CAABB98F0471D759707/997/256/{z}/{x}/{y}.png', 'max_zoom' => '18', 'attribution' => 'Map data © 2011 OpenStreetMap contributo'),
            array('basemap_id' => '2', 'map_id' => '1', 'basemap_name' => 'Night View', 'url' => 'http://{s}.tile.cloudmade.com/BC9A493B41014CAABB98F0471D759707/999/256/{z}/{x}/{y}.png', 'max_zoom' => '18', 'attribution' => 'Map data © 2011 OpenStreetMap contributo'),
            array('basemap_id' => '3', 'map_id' => '1', 'basemap_name' => 'Map Box', 'url' => 'http://a.tiles.mapbox.com/v3/mapbox.world-bright/{z}/{x}/{y}.png', 'max_zoom' => '18', 'attribution' => ''),
        ),
        'map' => array(
