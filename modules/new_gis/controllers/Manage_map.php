...
class Manage_map extends CMS_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        //$crud->columns('map_name', 'map_desc', 'latitude', 'longitude', 'gmap_roadmap', 'gmap_satellite', 'gmap_hybrid', 'zoom', 'height', 'width', 'layer', 'cloudmade_basemap');
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        ...
        $this->_save_one_to_many(
            ...
            $data, // DATA
            $real_column_list=array('layer_id', 'layer_name', 'group_name', 'layer_desc', 'z_index', 'shown', 'radius', 'fill_color', 'color', 'weight', 'opacity', 'fill_opacity', 'image_url', 'json_sql', 'json_shape_column', 'json_popup_content', 'json_label', 'use_json_url', 'json_url', 'searchable', 'search_sql', 'search_result_content', 'search_result_x_column', 'search_result_y_column', 'use_search_url', 'search_url'), // REAL DETAIL COLUMN NAMES
