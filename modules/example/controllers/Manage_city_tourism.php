...
/**
 * Description of Manage_city_tourism
 *
 * @author No-CMS Module Generator
 */
class Manage_city_tourism extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'city_tourism';
    protected $COLUMN_NAMES = array('city_id', 'tourism_id');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('City Tourism');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('city_id', 'tourism_id');
        //$crud->edit_fields('city_id', 'tourism_id', '_updated_by', '_updated_at');
        //$crud->add_fields('city_id', 'tourism_id', '_created_by', '_created_at');
        //$crud->set_read_fields('city_id', 'tourism_id');

        // caption of each columns
        $crud->display_as('city_id','City Id');
        $crud->display_as('tourism_id','Tourism Id');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_city_tourism_view', $output,
            $this->n('manage_city_tourism'), $config);
    }
