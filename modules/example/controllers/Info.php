...
class Info extends CMS_Module {
    ...
    protected $CONFIGS = array(
            ...
            // Browse City
            array(
                'config_name'   => 'example_city_record_template',
                'value'         => '<div id="record_{{ record:city_id }}" class="record_container panel panel-default">'.PHP_EOL.
    ...
    protected $PRIVILEGES = array(
            ...
            // Record Template City
            array(
                'privilege_name'   => 'edit_city_record_template',
                'authorization_id' => PRIV_AUTHORIZED,
            ),
