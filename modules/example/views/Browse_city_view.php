...
<div class="form form-inline">
    ...
    <?php
        ...
        if($have_edit_template_privilege){
            echo '<a href="{{ module_site_url }}browse_city/template_config" class="btn btn-default add_record"><i class="glyphicon glyphicon-cog"></i> Edit Record Template</a>'.PHP_EOL;
        }
    ?>
</div>
