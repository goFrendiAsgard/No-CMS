...
/**
 * Installation script for clausanoid_case
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.clausanoid_case';
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Clausanoid Case',
            $module_path.'/clausanoid_case', $this->PRIV_EVERYONE);
