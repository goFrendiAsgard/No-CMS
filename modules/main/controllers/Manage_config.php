...
/**
 * Description of Manage_config
 *
 * @author No-CMS Module Generator
 */
class Manage_config extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'main_config';
    protected $COLUMN_NAMES = array('config_name', 'value', 'description');
    ...
    protected function make_crud(){
        ...
        //$crud->edit_fields('config_name', 'value', 'description', '_updated_by', '_updated_at');
        //$crud->add_fields('config_name', 'value', 'description', '_created_by', '_created_at');
        //$crud->set_read_fields('config_name', 'value', 'description');

        // caption of each columns
        $crud->display_as('config_name','Config Name');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_config_view', $output,
            $this->n('main_config_management'), $config);
    }
