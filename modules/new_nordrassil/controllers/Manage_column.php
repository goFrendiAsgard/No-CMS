...
class Manage_column extends Nds_Special_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        //$crud->columns('table_id', 'name', 'caption', 'data_type', 'data_size', 'role', 'lookup_table_id', 'lookup_column_id', 'relation_table_id', 'relation_table_column_id', 'relation_selection_column_id', 'relation_priority_column_id', 'selection_table_id', 'selection_column_id', 'priority', 'value_selection_mode', 'value_selection_item', 'column_option');
        ...
        $crud->display_as('lookup_column_id','Lookup Column Id');
        $crud->display_as('relation_table_id','Relation Table');
        $crud->display_as('relation_table_column_id','Relation Table Column');
        $crud->display_as('relation_selection_column_id','Relation Selection Column Id');
        $crud->display_as('relation_priority_column_id','Relation Priority Column Id');
        $crud->display_as('selection_table_id','Selection Table');
        $crud->display_as('selection_column_id','Selection Column Id');
        ...
        $crud->display_as('column_option','Column Option');
    ...
    public function _callback_field_column_option($value, $primary_key){
        ...
        $data = $this->_one_to_many_callback_field_data(
                'column_option', // DETAIL TABLE NAME
                'id', // DETAIL PK NAME
                'column_id', // DETAIL FK NAME
        ...
        return $this->load->view($this->cms_module_path().'/field_column_column_option',$data, TRUE);
    }

    // returned on view
    public function _callback_column_column_option($value, $row){
        return $this->_humanized_record_count(
                'column_option', // DETAIL TABLE NAME
                'column_id', // DETAIL FK NAME
                $row->column_id, // CURRENT TABLE PK VALUE
                array( // CAPTIONS
                    'single_caption'    => 'Column Option',
                    'multiple_caption'  => 'Column Options',
                    'zero_caption'      => 'No Column Option',
                )
            );
    }
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        // SAVE CHANGES OF column_option
        $data = json_decode($this->input->post('md_real_field_column_option_col'), TRUE);
        $this->_save_one_to_many(
            'column_option', // FIELD NAME
            'column_option', // DETAIL TABLE NAME
            'id', // DETAIL PK NAME
            'column_id', // DETAIL FK NAME
