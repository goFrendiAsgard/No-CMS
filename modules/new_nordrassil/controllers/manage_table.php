 ...
 */
class Manage_Table extends CMS_Priv_Strict_Controller {
	...
	public function index(){
        ...
        // set model
        $crud->set_model($this->cms_module_path().'/grocerycrud_table_model');
        ...
        $crud->columns('project_id','name','caption','priority','options');
        // displayed columns on edit operation
        $crud->edit_fields('project_id','name','caption','priority','options');
        ...
        $this->view($this->cms_module_path().'/manage_table_view', $output,
            $this->cms_complete_navigation_name('manage_table'));
