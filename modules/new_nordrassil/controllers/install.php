...
/**
 * Installation script for new nordrassil
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.new_nordrassil';
    ...
    private function remove_all(){
        ...
        // remove navigations
        $this->remove_navigation($this->cms_complete_navigation_name('manage_template'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_table'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_project'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_column'));
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'New Nordrassil',
            $module_path.'/new_nordrassil', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('manage_column'), 'Manage Column',
            $module_path.'/manage_column', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_project'), 'Manage Project',
            $module_path.'/manage_project', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_table'), 'Manage Table',
            $module_path.'/manage_table', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_template'), 'Manage Template',
