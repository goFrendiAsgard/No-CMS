...
/**
 * Installation script for gis_assignment
 *
...
class Install extends CMS_Module_Installer {
    ...
    protected $NAME         = 'admin.gis_assignment';
    ...
    protected function do_deactivate(){
        ...
        $this->backup_database(array(
            $this->cms_complete_table_name('final'),
            $this->cms_complete_table_name('orphanage'),
            $this->cms_complete_table_name('religion')
        ));
        $this->remove_all();
    }
    ...
    private function remove_all(){
        ...
        // remove navigations
        $this->remove_navigation($this->cms_complete_navigation_name('manage_religion'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_orphanage'));
        $this->remove_navigation($this->cms_complete_navigation_name('manage_final'));
    ...
    private function build_all(){
        ...
        $this->add_navigation($this->cms_complete_navigation_name('index'), 'Gis Assignment',
            $module_path.'/gis_assignment', $this->PRIV_EVERYONE);

        // add navigations
        $this->add_navigation($this->cms_complete_navigation_name('manage_final'), 'Manage Final',
            $module_path.'/manage_final', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_orphanage'), 'Manage Orphanage',
            $module_path.'/manage_orphanage', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
        $this->add_navigation($this->cms_complete_navigation_name('manage_religion'), 'Manage Religion',
            $module_path.'/manage_religion', $this->PRIV_AUTHORIZED, $this->cms_complete_navigation_name('index')
        );
