    ...
    protected $TABLES = array(
        ...
        'entity' => array(
            ...
            'fields' => array(
                ...
                'per_user_limitation'  => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'id_authorization_view' => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'id_authorization_add' => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'id_authorization_edit' => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'id_authorization_delete' => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'id_authorization_browse' => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'field'                => array("type" => 'varchar',    "constraint" => 255, "null" => TRUE),
        ...
        'field' => array(
            ...
            'fields' => array(
                ...
                'input'                => array("type" => 'text',       "null" => TRUE),
                'view'                 => array("type" => 'text',       "null" => TRUE),
                'shown_on_add'         => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'shown_on_edit'        => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
                'shown_on_delete'      => array("type" => 'int',        "constraint" => 10,  "null" => TRUE),
        ...
        'group' => array(
            'key'    => 'group_id',
            'fields' => array(
                'group_id'             => 'TYPE_INT_UNSIGNED_AUTO_INCREMENT',
                'name'                 => array("type" => 'varchar',    "constraint" => 255, "null" => TRUE),
                'group_entity_add'     => array("type" => 'varchar',    "constraint" => 255, "null" => TRUE),
                'group_entity_edit'    => array("type" => 'varchar',    "constraint" => 255, "null" => TRUE),
                'group_entity_view'    => array("type" => 'varchar',    "constraint" => 255, "null" => TRUE),
        ...
        'option' => array(
            ...
            'fields' => array(
                ...
                'card_html'            => array("type" => 'text',       "null" => TRUE),
            ),
        ),
    );
