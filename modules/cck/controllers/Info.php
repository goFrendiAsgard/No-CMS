...
class Info extends CMS_Module {
    ...
    protected $DATA = array(
        'template' => array(
            ...
            array('id' => 5, 'name' => 'file', 'input' => '<a href="{{ module_base_url }}assets/uploads/{{ value }}">{{ value }}</a><br />\n<input id="field-{{ code }}" name="{{ code }}" type="file"" />', 'view' => '<a href="{{ module_base_url }}assets/uploads/{{ value }}">{{ value }}</a>')
        ),
    );
