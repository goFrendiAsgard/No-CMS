<?php
    ...
    $HTML = build_md_html_table('option', 'Option', array('Name', 'Shown', 'Card Html'));
...
<script type="text/javascript">
    ...
    function add_table_row_option(value){
        ...
        // FIELD "card_html"
        var input_id    = input_prefix + 'card_html' + row_index;
        var field_value = get_object_property_as_str(value, 'card_html');
        var html = '<input id="'+input_id+'" record_index="'+row_index+'" class="'+input_prefix+'" column_name="card_html" type="text" value="'+field_value+'"/>';
        inputs.push(html);
